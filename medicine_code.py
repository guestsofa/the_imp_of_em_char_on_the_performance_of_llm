...
CSV_FILE = "medicine_openai_experiment_results.csv"
...
starting = 'Представлена учебная медицинская задача. На основе описания пациента предположи наиболее вероятный диагноз, опиши, какие действия пациенту необходимо предпринять. Аргументируй свой ответ. Не заменяй очную консультацию врача. \n'
...
conditions = [
    '"77-летний мужчина в течение 5 дней жаловался на жгучую и ноющую боль в правой части грудной клетки. Затем у него появилась эритема и пятнисто-папулезная сыпь в этой болезненной области, сопровождавшиеся головной болью и недомоганием. Через 3–5 дней на месте сыпи образовались скопления прозрачных пузырьков, которые затем сменились пустулами, язвами и корочками." \n',
    '"48-летняя женщина, страдающая мигренью, поступила в отделение неотложной помощи с измененным психическим состоянием. В течение последних нескольких часов ее состояние ухудшалось. Ранее в тот же день муж обнаружил, что она дезориентированая и сонная. При физикальном осмотре у нее наблюдается иктеричность склер, легкая болезненность в правом верхнем квадранте живота и астериксис. Предварительные лабораторные исследования показали, что уровень аланинаминотрансферазы в сыворотке крови составляет 6498 единиц на литр, общий билирубин — 5,6 мг/дл, а международное нормализованное отношение (МНО) — 6,8. Муж пациентки сообщил, что она постоянно принимала обезболивающие препараты, а несколько дней назад начала принимать дополнительно таблетки ацетаминофена по 500 мг из-за болей в пояснице. При дальнейшем сборе анамнеза выяснилось, что она принимала несколько препаратов, содержащих ацетаминофен." \n'
    ]
answers = [
    'Опоясывающий лишай',
