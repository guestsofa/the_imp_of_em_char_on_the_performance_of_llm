...
На изображении белой стрелкой изображен последний ход белых фигур. Следующий ход - за черными фигурами.

Сначала восстанови позицию: список фигур по клеткам и FEN. Затем найди самый короткий форсированный мат за сторону черных фигур. Соперник защищается лучшими ходами.
...
for i in range(11, TASKS_COUNT + 1):
    tasks.append({
