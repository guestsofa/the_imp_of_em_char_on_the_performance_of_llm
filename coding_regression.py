...
# -*- coding: utf-8 -*-
"""
Унифицированный скрипт регрессионного анализа для задачи: Кодинг.
...
REQUIRED_COLUMNS = ['judge_solution_score_0_10', 'question_id']
...
ACCEPTED_JUDGE_STATUS_VALUES = ['success', 'api', 'None']
