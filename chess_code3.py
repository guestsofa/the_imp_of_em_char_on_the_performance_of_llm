...
Следующий ход - за белыми фигурами.

Сначала восстанови позицию: список фигур по клеткам и FEN. Затем найди самый короткий форсированный мат за сторону белых фигур. Соперник защищается лучшими ходами.
...
for i in range(20, TASKS_COUNT + 1):
    tasks.append({
