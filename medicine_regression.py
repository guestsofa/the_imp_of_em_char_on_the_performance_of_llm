...
# -*- coding: utf-8 -*-
"""
Унифицированный скрипт регрессионного анализа для задачи: Медицина.
...
TASK_NAME = 'Медицина'
DEPENDENT_VAR = 'judge_score_0_10'
MODEL_KIND = 'ols'  # "logit" или "ols"
DEFAULT_STEM = 'medicine'
DEFAULT_SHEET = None
...
REQUIRED_COLUMNS = ['judge_score_0_10', 'question_id']
