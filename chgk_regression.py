...
# -*- coding: utf-8 -*-
"""
Унифицированный скрипт регрессионного анализа для задачи: ЧГК.
...
TASK_NAME = 'ЧГК'
DEPENDENT_VAR = 'answer_match'
MODEL_KIND = 'logit'  # "logit" или "ols"
DEFAULT_STEM = 'chgk'
DEFAULT_SHEET = 'Лист1'
...
ACCEPTED_STATUS_VALUES = None
ACCEPTED_JUDGE_STATUS_VALUES = None
...
ALLOW_DERIVE_QUESTION_ID = False
